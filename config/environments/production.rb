Rails.application.configure do
  ...
  config.public_url = 'https://03b216eb.ngrok.io';
  
  # shopify app creds
  config.shopify_api_key = "b7d7dc0a6162fe923e6807da5247c180"
  config.shopify_secret = "96c208a7ab604607662485ca8f7ef230"
